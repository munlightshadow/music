...
2. **Productive (применение)**  
   Практика речи в Zoom → три задания тьютору (письмо 37, эссе 38, говорение 4) → итоговый тест с автопроверкой.

Критерии **РКЗ** и **организация** проверяются полностью с модуля 1.  
...
| Вводное видео (слайды + речь) | Есть, без примеров работ. Пример про Present Simple в речи эксперта оставляем |
| Полный перечень элементов кодификатора | Есть. Уточнение: 38 = эссе-проект с элементами делового письма, CV нет |
