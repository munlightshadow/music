...
| [GAPS.md](GAPS.md) | Что закрыто; рекомендации по косым клеткам 10/11; чего ещё нет |
...
flowchart TD
  ...
  C -->|10 + продвинутая / 11 + базовая| Q[Не автомат: рекомендации в GAPS.md]
  I --> F[ЕГЭ]
  J --> F
```
...
- **Косые клетки** (B1 в 10 классе, A2 в 11 классе): не автомат. Рекомендации — [GAPS.md](GAPS.md); каталог вариантов — [placement-options.md](00-architecture/placement-options.md).
...
| Размещение группа × класс | Отсев и идеалы зафиксированы. Косые клетки: рекомендации в [GAPS.md](GAPS.md), автор ещё не утвердил |
| Структура ЕГЭ и критерии 37 / 38 / задания 4 | Есть |
| Накопительный принцип фидбека | Есть |
| Шаблоны тьютора | Есть: бланки 37 / 38 / 4 |
| Макеты бренда | Есть: [шаблон-документа.pdf](brand/шаблон-документа.pdf), [шаблон-презентации.pptx](brand/шаблон-презентации.pptx) |
...
| Диагностический тест и cut-off середины B1 | Шкала Cambridge и отсев зафиксированы. Теста нет. Косые клетки — рекомендации в GAPS, не автомат |
