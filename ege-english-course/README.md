...
| [03-curriculum](03-curriculum/module-index.md) | Сетка 0–20 по юнитам Solutions; [что берём и выбрасываем](03-curriculum/solutions-mapping.md) |
...
| Распределение элементов по модулям 1–20 | Порядок = Solutions Intro+1–9 × 2. Что брать/выбрасывать: [solutions-mapping.md](03-curriculum/solutions-mapping.md) |
