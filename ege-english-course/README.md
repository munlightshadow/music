...
| Папка | Содержание |
| --- | --- |
| [00-architecture](00-architecture/course-map.md) | Два года, 20 модулей, вводный, диагностика Cambridge, [варианты косых клеток](00-architecture/placement-options.md) |
...
| [GAPS.md](GAPS.md) | Чего ещё нет; матрица сила × класс (ярлыки только внутри команды) |
...
flowchart TD
  ...
  T -->|ниже A2| X
  T -->|A2 — начало B1 внутри: слабый| C{Класс}
  T -->|уверенный B1–B2 внутри: сильный| C
  C -->|10 + слабый| I[Вводный → модули 1–20]
  C -->|11 + сильный| J[Вводный → 11–20, база 1–10 открыта]
  C -->|10 + сильный / 11 + слабый| Q[Не автомат: placement-options.md]
  I --> F[ЕГЭ]
  J --> F
```

Ярлыки «слабый / сильный» на схеме — **командные**. Клиенту: CEFR и маршрут модулей.
...
- **Пока нет маршрута:** сильный 10-классник и слабый 11-классник — варианты в [placement-options.md](00-architecture/placement-options.md).
...
| Размещение сила × класс | Отсев и идеалы зафиксированы. Две косые клетки: варианты есть, маршрута нет |
...
| Вводный модуль для ученика | Презентация **67 слайдов** + [речь эксперту](03-curriculum/intro-student/presentation-script.md); обзор всех заданий; бланки; 37 / 38 / говорение 1–4 |
