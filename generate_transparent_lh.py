...
def generate_transparent_lighthouse_svg(size=1200):
    """
    Exact vector artwork of the lighthouse (beams, water ripples, rock, tower, gallery, lantern, dome, spire)
    without any background circle or clipping circle, transparent background.
    """
  ...
  <defs>
    ...
    <linearGradient id="goldBeamL" x1="470" y1="385" x2="50" y2="395" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="100%" stop-color="#C19B4F" stop-opacity="0.45" />
    </linearGradient>
  ...
  <!-- Vertical Accent / Subtle Shading on Tower -->
...
if __name__ == '__main__':
    svg_str = generate_transparent_lighthouse_svg()
    with open('/workspace/lighthouse_transparent.svg', 'w', encoding='utf-8') as f:
        f.write(svg_str)
    cairosvg.svg2png(url='/workspace/lighthouse_transparent.svg', write_to='/workspace/lighthouse_transparent.png', output_width=1200, output_height=1200)
    print("Saved lighthouse_transparent.svg and lighthouse_transparent.png")
